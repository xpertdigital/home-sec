    ...
    <footer className="bg-primary-dark text-primary-foreground pt-20 pb-8">
      <div className="container-x grid lg:grid-cols-4 gap-10">
        <div>
          ...
          <p className="mt-5 text-sm text-primary-foreground/75">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis.</p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/80">
            {["Homepage", "About Us", "Our Clients", "Our Services", "Pricing Package", "Our Portfolio"].map((l) => (
        ...
        <div>
          ...
          <p className="text-sm text-primary-foreground/80">California State Number 123 Block M Krokolan View Gg. 456 Brooklin</p>
          <div className="mt-4 text-sm">
            <div className="font-semibold">Telephone</div>
            <div className="text-primary-foreground/80">( +44 ) 123 456 789</div>
          </div>
          <div className="mt-3 text-sm">
            <div className="font-semibold">Email Address</div>
            <div className="text-primary-foreground/80">Hello@Email.com</div>
          </div>
        </div>
      </div>
      ...
      <div className="container-x mt-14 pt-6 border-t border-white/10 flex flex-wrap items-center justify-between gap-4 text-xs text-primary-foreground/70">
        <div>© Allright Reserved — HouseSec Kit</div>
